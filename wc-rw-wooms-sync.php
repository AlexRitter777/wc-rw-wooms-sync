...
class Wc_Rw_Wooms_Sync {
    ...
    public function load_admin_scripts($hook){
        ...
        wp_enqueue_script('wc-rw-wooms-sync-ajax-script', WP_PLUGIN_URL  . '/wc-rw-wooms-sync/assets/js/ajax.js', array('jquery'), "1.4.2", true);
        ...
        wp_enqueue_style( 'wc-rw-wooms-sync-admin-style', WP_PLUGIN_URL . '/wc-rw-wooms-sync/assets/css/admin.css', array(), '1.4.2' );
